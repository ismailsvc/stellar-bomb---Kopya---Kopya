...
import type { Puzzle, UserProfile, LeaderboardEntry, GameDifficulty } from "../types";
import {
  sound,
  playClick,
} from "../utils";
import { TOTAL_TIME_BY_DIFFICULTY, DEFAULT_MISTAKES_BY_DIFFICULTY } from "../constants";
import { generatePuzzleWithAI, validateCodeWithAI } from "../lib";
import { saveScore, loadGlobalLeaderboard } from "../lib";
import { puzzles } from "../puzzles";
import { updatePlayerStats, saveLocalLeaderboard } from "../utils";
