...
import type { LeaderboardEntry, PlayerStats, GameDifficulty, UserProfile } from "../types";
import { STORAGE_KEYS, AVATARS } from "../../config/constants";
...
export const loadProfile = (address: string): UserProfile => {
  ...
  return JSON.parse(localStorage.getItem(STORAGE_KEYS.PROFILE(address)) || JSON.stringify(defaultProfile));
};

export const saveProfile = (address: string, profile: UserProfile): void => {
